...
const About = () => {
  return (
    <div className="container" style={{ padding: "20px" }}>
      ...
      <p>Whether you’re here to find the perfect photo or video for your project or to share your unique perspective, we welcome you to the WiSaw family. Together, we can redefine what stock media means by putting authenticity and creativity at the forefront.
